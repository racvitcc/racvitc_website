...
export const coreTeam: Member[] = [
  ...
  { name: "N V Tejaharshini", role: "Joint Secretary", year: YEAR, img: "/team/joint-secretary.png", confirmed: true },
  { name: "Nirmal", role: "Chief Sergeant", year: YEAR, img: "/team/chief-sergeant.png", confirmed: true },
